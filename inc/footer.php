		...
		<div class="clear"></div>
			<footer class="round">
			<ul>
			<li>&copy; 2010-<?php echo date("Y") ?> Contributors incl. <a href="profile.php" title="It is you that make it!" target="_blank"><?php echo getEncryptCookie('twitese_name')?></a></li>
